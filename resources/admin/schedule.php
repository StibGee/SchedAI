    ...
    <main>
        <div class="container mb-1">
            ...
            <div class="row d-flex align-items-center">
                ...
                <div class="col-3 ">
                    <button class="generate" data-toggle="modal" data-target="#formModal">new</button>
        ...
        <div class="modal-content border-0">
            <div class="modal-body p-3">
                <div class="position-absolute top-0 end-0 mt-3 me-3 z-1">
                    <button type="button" class="btn-close" onclick="window.location.href='schedule.php'"  aria-label="Close"></button>
                </div>
                ...
                <div class="modal-footer d-flex justify-content-between">
                    <button type="button" class="cancel" onclick="window.location.href='schedule.php'">Cancel</button>
