        ...
        <div class="container mb-5">
            ...
            <div class="row mt-4 d-flex align-items-center">
                ...
                <div class="col-2 add-account d-flex justify-content-end">
                    <button class="add-subject" data-toggle="modal" data-target="#formModal"><i class="fa-solid fa-folder-plus custom-icon-size"></i></button>
                </div>
                    ...
                    <div class="modal-content border-0">
                        <div class="modal-body p-3">
                            <div class="position-absolute top-0 end-0 mt-3 me-3 z-1">
                                <button type="button" class="btn-close" onclick="window.location.href='account-view.php'"  aria-label="Close"></button>
                            </div>
                            ...
                            <div class="modal-footer d-flex justify-content-between">
                                <button type="button" class="cancel" onclick="window.location.href='account-view.php'">Cancel</button>
