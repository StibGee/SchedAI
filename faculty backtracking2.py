...
cursor.execute("SELECT * FROM `subjectschedule` JOIN subject ON subjectschedule.subjectid=subject.id WHERE focus!='Minor' AND focus!='Major1' ORDER BY subjectschedule.departmentid ASC")
