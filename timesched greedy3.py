...
try:
    ...
    cursor.execute("UPDATE `subjectschedule` SET `timestart` = NULL, `timeend` = NULL,`day` = NULL,  `roomname` = NULL;")
    conn.commit() 
...
for subject in subjectschedule:
    ...
    subjectid, subject_name, units, subject_type, subjectfacultyid = subject[0], subject[12], subject[13], subject[15], int(subject[10])
            ...
            for facultyidpair, slots in facultypairdaystime.items():
                ...
                for day1, day2, starttime, endtime in slots:
                    ...
                    if day1free and day2free and facultyday1free and facultyday2free:
                        ...
                        print(f"assigned subject {subjectid} in {roomname} to this day {day2} and {day1} w/ time slot starting at {minutestotime(startminutes)} upto {minutestotime(end_minutes)}")
                        print('')
                        for time_slot in range(startminutes, end_minutes, 30):
