    ...
    <main>
        <div class="container mb-5">
            ...
            <div class="row d-flex justify-content-center align-items-center">
                ...
                <div class="button col-4 d-flex justify-content-end">
                    <button type="button" class="confirm mr-4" onclick="window.location.href='generated-sched.php'">Generate</button>
                    <button id="assign" onclick="window.location.href='final-sched.php'">Save</button>
                </div>

            </div>
            <div class="sched-container my-5">
                <div class="d-flex ">
